...
const SavedShows = () => {
  ...
  return (
    <>
      <h2 className="text-white p-4 font-bold md:text-xl lg:text-2xl">
        Saved Movies
      </h2>
          ...
          {movies.map((item) => (
            ...
            >
              <img
                ...
                alt={item?.title}
              />
              <div className="absolute top-0 left-0 w-full h-full hover:bg-black/70 opacity-0 hover:opacity-100 text-white transition-all duration-500 p-3">
